...
#define LOG_EMERG(x, ...)   aocl::Log::print(aocl::Log::EMERG,   x, ##__VA_ARGS__)
#define LOG_ALERT(x, ...)   aocl::Log::print(aocl::Log::ALERT,   x, ##__VA_ARGS__)
#define LOG_CRIT(x, ...)    aocl::Log::print(aocl::Log::CRIT,    x, ##__VA_ARGS__)
#define LOG_ERR(x, ...)     aocl::Log::print(aocl::Log::ERR,     x, ##__VA_ARGS__)
#define LOG_WARN(x, ...)    aocl::Log::print(aocl::Log::WARNING, x, ##__VA_ARGS__)
#define LOG_NOTICE(x, ...)  aocl::Log::print(aocl::Log::NOTICE,  x, ##__VA_ARGS__)
#define LOG_INFO(x, ...)    aocl::Log::print(aocl::Log::INFO,    x, ##__VA_ARGS__)
#define LOG_VERBOSE(x, ...) if (aocl::Log::verbose() > 0) { aocl::Log::print(aocl::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V1(x, ...)      if (aocl::Log::verbose() > 0) { aocl::Log::print(aocl::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V2(x, ...)      if (aocl::Log::verbose() > 1) { aocl::Log::print(aocl::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V3(x, ...)      if (aocl::Log::verbose() > 2) { aocl::Log::print(aocl::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V4(x, ...)      if (aocl::Log::verbose() > 3) { aocl::Log::print(aocl::Log::INFO, x, ##__VA_ARGS__); }
#define LOG_V5(x, ...)      if (aocl::Log::verbose() > 4) { aocl::Log::print(aocl::Log::INFO, x, ##__VA_ARGS__); }

#ifdef APP_DEBUG
#   define LOG_DEBUG(x, ...) aocl::Log::print(aocl::Log::DEBUG, x, ##__VA_ARGS__)
#else
#   define LOG_DEBUG(x, ...)
#endif

#if defined(APP_DEBUG) || defined(APP_DEVEL)
#   define LOG_DEBUG_ERR(x, ...)  aocl::Log::print(aocl::Log::ERR,     x, ##__VA_ARGS__)
#   define LOG_DEBUG_WARN(x, ...) aocl::Log::print(aocl::Log::WARNING, x, ##__VA_ARGS__)
#else

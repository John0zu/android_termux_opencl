...
aocl::OclDevice::OclDevice(uint32_t index, cl_device_id id, cl_platform_id platform) :
    m_id(id),
    m_platform(platform),
...
aocl::String aocl::OclDevice::printableName() const
{
...
uint32_t aocl::OclDevice::clock() const
{
...
#ifdef AOCL_FEATURE_API
void aocl::OclDevice::toJSON(rapidjson::Value &out, rapidjson::Document &doc) const
{
